...
CREATE TABLE "review_settings" (
    ...
    "incentiveValue" DOUBLE PRECISION NOT NULL DEFAULT 10,
...
CREATE TABLE "review_qa" (
    ...
    CONSTRAINT "review_qa_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "smart_cart_settings" (
    ...
    "freebieThreshold" DOUBLE PRECISION NOT NULL DEFAULT 999,
    ...
    "codMaxOrderValue" DOUBLE PRECISION NOT NULL DEFAULT 10000,
...
CREATE TABLE "video_widgets" (
    ...
    CONSTRAINT "video_widgets_pkey" PRIMARY KEY ("id")
);
